...
| [0004](0004-scope-from-token-audience.md) | A caller's scope comes from its token's audience, never a parameter |
| [0005](0005-erasure-is-a-setting.md) | Erasure is a setting, and forgetting is not yet gone |
| [0006](0006-provenance-is-partly-a-claim.md) | Provenance is half verified and half a claim, and the API says which |
